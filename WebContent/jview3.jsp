...
if(rs1.next())
{
	 ...
	 %>
						 <table>
						 <tr><th><u><%=rs1.getString(2)%>:<u>&nbsp;&nbsp;&nbsp;</th>&nbsp;&nbsp;&nbsp;<th>.</th></tr><tr><th><font Style="color:#ff3333">
                            <%=rs1.getString(4)%> </th></tr></table><br><br><br><br>
							<table>
...
%>
                     ...
                     <tr></tr><tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<tr></tr>
					 <tr>
                    <th><font style="" size="4"><%=rs.getString(5)%></font></th>  <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    -</th><th><font style="" size="2"><i><%=rs.getString(7)%></font></i></th>    
					<%}}
					
					else{
					response.sendRedirect("jviewdoubt.jsp?nomsg=no");
					}%>  
							  <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button type="submit" class="btn btn-primary btn-lg">&nbsp;&nbsp;<a href="jviewdoubt.jsp">Back</button></th></tr></table>
                        <br><br>
